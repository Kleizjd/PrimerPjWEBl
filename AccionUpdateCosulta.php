...
/* Sentencia Preparada, etapa 1: preparación */
 ...
 if (!$sentencia) {
	 ...
	 $sentence= $conexion->prepare($bene1);$sentence->bind_param("i", $documento);$sentence->execute();$regist=$sentence->get_result(); 
if ((($regempleado=$registros->fetch_assoc()))&&(($regem=$regis->fetch_assoc()))&&(($reg=$regist->fetch_assoc()))){ 
?>
...
<form action="AccionUpdateConsulta2.php" method="post"><tr><td>
<table border="3" bgcolor="#f18787"><tr><td style="color:#ffffff" bgcolor="#797575">
<strong><em>Actualizar Datos Basicos Afiliado</em></strong></td></tr>
    <tr><td> TipoDocumento: <input type="text" name="tipo" value="<?php echo $regempleado['TipoDocumento'] ?>" >
...
</td></tr><tr><td> Municipio: <input type="text" name="mu" value="<?php echo $regempleado['Municipio'] ?>">
</td><td> Departamento: <input type="text" name="dep" value="<?php echo $regempleado['Departamento'] ?>">
...
</td></tr><tr><td> MunNacimiento: <input type="text" name="mun" value="<?php echo $regempleado['MunNacimiento'] ?>">
</td><td> DepNacimiento: <input type="text" name="depn" value="<?php echo $regempleado['DepNacimiento'] ?>">
</td><td> FechaN: <input type="text" name="fechan" value="<?php echo $regempleado['FechaN'] ?>">
...
<table border="3" bgcolor="#f18787">
 <tr><td style="color:#ffffff" bgcolor="#797575">
  ...
  <tr><td> TipoDocumento: <input type="text" name="tipo0" value="<?php echo $regem['Tipodocumento'] ?>" >
...
</td><td>Novedad: <input type="text" name="nov0" value="<?php echo $regem['Novedad'] ?>">
</td><td>Nacionalidad: <input type="text" name="nacio0" value="<?php echo $regem['Nacionalidad'] ?>">
</td></tr><tr><td>DirResidencia: <input type="text0" name="dire" value="<?php echo $regem['DirResidencia'] ?>">
</td><td>Municipio: <input type="text" name="mu0" value="<?php echo $regem['Municipio'] ?>">
</td><td>Departamento: <input type="text" name="dep0" value="<?php echo $regem['Departamento'] ?>">
</td></tr><tr><td>FechaN: <input type="text" name="fechan0" value="<?php echo $regem['FechaN'] ?>">
...
</td><td>Correo: <input type="text" name="correo0" value="<?php echo $regem['Correo'] ?>">
</table>

<table border="3" bgcolor="#f18787">
 <tr><td style="color:#ffffff" bgcolor="#797575">
   <em>Beneficiario 2</em></strong></td><tr>
  <tr><td> TipoDocumento: <input type="text" name="tipo1" value="<?php echo $reg['Tipodocumento'] ?>" >
    </td><td>NDocumento: <input type="text" name="doc1" value="<?php echo $reg['NDocumento'] ?>" >
	</td></tr><tr><td> Primer Apellido: <input type="text" name="pap1" value="<?php echo $reg['PrimerApellido'] ?>">
	</td><td> Segundo Apellido: <input type="text" name="sap1" value="<?php echo $reg['SegundoApellido'] ?>">
</td></tr><td>Primer Nombre: <input type="text" name="pnombre1" value="<?php echo $reg['PrimerNombre'] ?>">
</td><td> Segundo Nombre: <input type="text" name="snombrea" value="<?php echo $reg['SegundoNombre'] ?>">
</td><td> Sexo: <input type="text" name="sexo1" value="<?php echo $reg['Sexo'] ?>">
</td></tr><tr><td> Parentesco: <input type="text" name="par1" value="<?php echo $reg['Parentesco'] ?>">
</td><td>Novedad: <input type="text" name="nov1" value="<?php echo $reg['Novedad'] ?>">
</td><td>Nacionalidad: <input type="text" name="nacio1" value="<?php echo $reg['Nacionalidad'] ?>">
</td></tr><tr><td>DirResidencia: <input type="text" name="dire1" value="<?php echo $reg['DirResidencia'] ?>">
</td><td>Municipio: <input type="text" name="mu1" value="<?php echo $reg['Municipio'] ?>">
</td><td>Departamento: <input type="text" name="dep1" value="<?php echo $reg['Departamento'] ?>">
</td></tr><tr><td>FechaN: <input type="text" name="fechan1" value="<?php echo $reg['FechaN'] ?>">
</td><td>Telefono: <input type="text" name="tel1" value="<?php echo $reg['Telefono'] ?>">
</td><td>Celular: <input type="text" name="cel1" value="<?php echo $reg['Celular'] ?>">
</td><td>Correo: <input type="text" name="correo1" value="<?php echo $reg['Correo'] ?>">
</table>
