...
if (!$sent) {
	 printf("Problemas en la Sentencia Preparada.\n". $conexi->error . "\n"); }							   
 $sent->bind_param("ssisssssssssssssssi",$_POST['doc'],$_POST['tipo1'],$_POST['doc1'],$_POST['sexo1'], $_POST['pap1'], $_POST['sap1'], $_POST['pnombre1'],$_POST['snombrea'],
                                               $_POST['par1'],$_POST['nov1'],$_POST['nacio1'],$_POST['dire1'],$_POST['mu1'],$_POST['dep1'],
											   $_POST['fechan1'], $_POST['tel1'],$_POST['cel1'],$_POST['correo1'],$_POST['documentoAnt']); 
	if (!$sent) { 
printf("Problemas en la Vinculación de Parámetros.\n". $conexi->error . "\n");
 } 
     $sent->execute();
...
/* se recomienda el cierre explícito de la Sentencia */$sent->close(); $conexi->close();
/*----------------------------------------------------------------------------------------------------------------------------------------------------------------*/
