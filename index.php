...
<head>
    ...
    <!-- Owl-Carousel-CSS -->
    <!-- <link rel="stylesheet" href="vendors/css/owl.carousel.css" type="text/css" media="all" /> -->
    <!-- Popup-Box-CSS -->
    <!-- <link rel="stylesheet" href="vendors/css/popuo-box.css" type="text/css" media="all" /> -->
