...
<head>
	<title>Borrado de registros de tabla </title>
	<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
</head>

<body> <?php require_once("../Config/Config.php");
		include "../libraries/core/conexion.php";
		$conexion = new conexion();

		$sql = "SELECT TipoDocumento,Documento,PrimerNombre,SegundoNombre,PrimerApellido,SegundoApellido,DirResidencia,Municipio,Departamento,Barrio,Telefono,Celular,Correo,MunNacimiento,DepNacimiento,FechaN,Ocupacion1Apellido,2Apellido,1Nombre,2Nombre,Sexo,Ndocumento,TipDocumento,FechaExpe FROM afiliado WHERE Documento='" . $_REQUEST['documento'] . "'";

		$registros = $conexion->executeSQL($sql);
		if (!$registros) {printf("Problemas en el Select.\n" . $conexion->error . "\n");}

		if ($reg = $consulta->fetch(PDO::FETCH_BOTH)) {

			echo  "<table border=2 bgcolor=#d9697c></tr><tr><td style=color:#ffffff bgcolor=#797575>DATOS ACTUALES DEL AFILIADO</td></tr>s<tr><td>
